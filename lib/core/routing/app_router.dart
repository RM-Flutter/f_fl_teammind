...
import 'package:app_test/features/services/views/all_free_services/free_service_home_childs/get_team_mind_system/views/about_team_mind_screen.dart';
...
import 'package:app_test/features/services/views/all_free_services/free_service_home_childs/premium_templates/views/premium_templates_screen.dart';
import 'package:app_test/features/services/views/common_ui/select_template_screen.dart';
import 'package:app_test/features/services/views/all_free_services/free_service_home_childs/smart_card/views/smart_card_company/smart_card_company_detail_screen.dart';
import 'package:app_test/features/services/views/all_free_services/free_service_home_childs/smart_card/views/smart_card_profile/smart_card_profile_detail_screen.dart';
import 'package:app_test/features/services/views/all_free_services/free_service_home_childs/smart_card/views/smart_card_screen.dart';
import 'package:app_test/features/services/views/all_free_services/free_service_home_childs/smart_card/views/smart_card_company/widgets/update_company_info_screen.dart';
import 'package:app_test/features/services/views/all_free_services/free_service_home_childs/smart_card/views/smart_card_profile/widgets/update_employee_info_screen.dart';
...
import 'package:app_test/features/services/views/all_free_services/free_service_home_childs/valcation_calc/views/vacation_calc_screen.dart';
import 'package:app_test/features/services/views/all_free_services/free_service_home_childs/get_team_mind_system/views/widgets/youtube_video_player/widgets/youtube_video_player.dart';
...
import '../services/telegram_error_service.dart';
        ...
        routes: [
          GoRoute(
            ...
            pageBuilder: (context, state) {
              ...
              TelegramErrorService.setCurrentScreen(screenName, context: context);
...
// Make sure to dispose the controller after the transition is complete
    ...
    errorBuilder: (context, state) {
      ...
      final screenName = state.uri.path.split('/').last;
      TelegramErrorService.setCurrentScreen(screenName);
