...
class CustomerServiceRequestDetailsAppbarWidget extends StatelessWidget {
  GetOneRequestModel? getOneRequestModel;
  List? types;
  CustomerServiceRequestDetailsAppbarWidget({super.key, this.getOneRequestModel, this.types});
  var type;
  @override
