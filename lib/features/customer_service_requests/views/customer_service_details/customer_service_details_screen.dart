...
import 'package:app_test/features/customer_service_requests/views/customer_service_details/widgets/request_details_appbar_widget.dart';
import 'package:app_test/features/customer_service_requests/views/customer_service_details/widgets/request_details_loading_screen.dart';
...
class CustomerServiceDetailsScreen extends StatefulWidget {
  var id;
  CustomerServiceDetailsScreen({super.key, required this.id});

  @override
  State<CustomerServiceDetailsScreen> createState() => _CustomerServiceDetailsScreenState();
}

class _CustomerServiceDetailsScreenState extends State<CustomerServiceDetailsScreen> {
...
// Keep track of loaded pages
  ...
  Widget build(BuildContext context) {
    return MultiProvider(providers: [
      ChangeNotifierProvider(create: (context) => CustomerRequestController()..getOneRequest(context, widget.id),),
      ChangeNotifierProvider(create: (context) => CommentProvider()..getComment(context, "csrequests", widget.id),),
    ],
      child: Consumer<CustomerRequestController>(
          ...
          return Consumer<CommentProvider>(
            builder: (context, values, child) {
              return Scaffold(
                  ...
                  child: GradientBgImage(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          CustomerServiceRequestDetailsAppbarWidget(
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(AppStrings.lastedComments.tr().toUpperCase(), style: TextStyle(fontSize: 14,
                                            fontWeight: FontWeight.w500, color: Color(AppColors.primary))),
                                        Expanded(
                                          child: Padding(
                                            padding: const EdgeInsets.symmetric(horizontal: 10),
                                            child: Container(
                ...
                ): const CustomerServiceRequestDetailsLoadingScreen(),
              );
            },
          );
        },
