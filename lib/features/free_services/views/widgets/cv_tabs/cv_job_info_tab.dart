      ...
      child: Column(
        ...
        children: [
          ...
          CVInfoItem(
            ...
            value: jobInfo?.aboutMe ?? jobInfo?.description,
          ),
          CVInfoItem(
            label: 'SKILLS',
            value: jobInfo?.skills?.join(', '),
            hint: '(اختيار من الموجود)',
          ),
          CVInfoItem(
            label: 'MORE SKILLS',
            value: jobInfo?.moreSkills?.join(', '),
  ...
  Widget _buildExperienceItem(CVExperience exp) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          CVInfoItem(label: 'COMPANY NAME', value: exp.companyName, isRequired: true),
          CVInfoItem(label: 'COUNTRY', value: exp.country),
          CVInfoItem(label: 'GOVERNORATE/STATE', value: exp.governorateState, isRequired: true),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CVInfoItem(label: 'وصف المشروع', value: portfolio.description),
          CVInfoItem(label: 'رابط المشروع', value: portfolio.link),
        ],
      ),
    );
  }
