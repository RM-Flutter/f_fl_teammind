                                  ...
                                  children: [
                                    ...
                                    if((viewModel.requestsTypes == null || viewModel.requestsTypes!.isEmpty)
                                      ...
                                      onChanged: (String? values) {
                                        ...
                                        debugPrint("selectedItem --> ${AppConstants.requestsTypess}");
                                        debugPrint("TYPE  IS --> ${viewModel.reqType}");
                                        debugPrint("TYPE  IS --> ${viewModel.reqTypeFile}");
                                      },
                                    ),
                                    gapH14,
                                    viewModel.reqType ==
                                    ...
                                    //     builder: (context, viewModel, child) {
                                    //       debugPrint("FIELDS IS --> ${viewModel.selectedRequestType?['fields']}");
                                    //   final attachingFile =
