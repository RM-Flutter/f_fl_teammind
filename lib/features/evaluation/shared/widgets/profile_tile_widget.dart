      ...
      builder: (context) {
        return Container(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Text(AppStrings.evaluationsInfo.tr(),style: TextStyle(fontSize: 20, color: Color(AppColors.dark), fontWeight: FontWeight.w600),),
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Column(
                        ...
                        children: [
                          Text(title,style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14, color: Color(AppColors.realDark))),
                          Text("$empName - $department",style: TextStyle(fontWeight: FontWeight.w400, fontSize: 12, color: Color(AppColors.grey70))),
                          Text(name,style: TextStyle(fontWeight: FontWeight.w600, fontSize: 12, color: Color(AppColors.grey70))),
