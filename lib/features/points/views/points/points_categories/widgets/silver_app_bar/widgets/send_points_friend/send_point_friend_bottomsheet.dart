...
import 'package:app_test/features/authentication/shared/widgets/phone_number_field.dart';
...
import 'package:app_test/features/points/controllers/points_controller/points_controller.dart';
import 'package:app_test/features/points/views/points/points_categories/widgets/silver_app_bar/widgets/send_points_friend/widgets/send_point_confirm_bottomsheet.dart';
  ...
  Widget build(BuildContext context) {
    ...
    child: Consumer<HomeController>(
      builder: (context, values, child) {
        return Consumer<PointsController>(builder: (context, value, child) {
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          defaultTextFormFieldPoints( focusNode: pointsFocusNode,
                                    onTap: () {
