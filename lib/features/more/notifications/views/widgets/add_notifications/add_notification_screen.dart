                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  validator: (String? value) {
                                    if (value!.isEmpty) {
                                      return "${AppStrings.titleAr
                                          .tr()} ${AppStrings.isRequired.tr()}";
                                    } else {
                                      return null;
                                    }
                                  },
                                ...
                                defaultDropdownField(
                                  ...
                                  title: viewModel.selectNotificationType ??
                                      AppStrings.type.tr(),
                                  items: viewModel.notificationsType.map((e) =>
                                      DropdownMenuItem(
                                  ...
                                  onChanged: (String? values) {
                                    ...
                                    setState(() {
                                      ...
                                      print(
                                          "selectNotificationType is --> ${viewModel
                                ...
                                if(viewModel.selectNotificationType ==
                                    "some_employees" &&
                                    viewModel.employees.isNotEmpty) gapH14,
                                if(viewModel.selectNotificationType ==
                                    "some_employees" && viewModel.employees
                                    .isNotEmpty) GestureDetector(
                                  onTap: () async {
                                    String searchQuery = "";
                                    List<Map> filteredEmployees = viewModel
                                        .employees;
                                ...
                                if(viewModel.selectNotificationType ==
                                    "departments" &&
                                    viewModel.departments.isNotEmpty) gapH14,
                                if(viewModel.selectNotificationType ==
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    ElevatedButton(
                                                      onPressed: () {
                                                        print(
                                                            "tempDepSelectedIds --> ${tempDepSelectedIds}");
                                                        print(
                                                            "listIds --> ${viewModel
                                                                .listIdsDepartment}");
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                            ...
                                            CustomElevatedButton(
                                                onPressed: () async {
                                                  await viewModel.getImage(
                                                      context,
                                                      image1: viewModel
                                                          .attachmentPersonalImage,
                                                      image2: viewModel
                                                          .XImageFileAttachmentPersonal,
                                                      list2: viewModel
                                        ...
                                        if(viewModel.listAttachmentPersonalImage
                                            .isNotEmpty) SizedBox(
                                          height: 90,
                                          child: GridView.builder(
                                            ...
                                            const SliverGridDelegateWithFixedCrossAxisCount(
                                                crossAxisCount: kIsWeb == true
                                                    ? 7
                                                    : 4
                                            ),
                                            itemBuilder: (c, i) {
                                              return buildCustomContainer(
                                                  file: CheckValuesFromApi
                                                      .safeArray(viewModel
                                                      .listAttachmentPersonalImage)[i]['compressed'],
                                                  xFile: CheckValuesFromApi
                                                      .safeArray(viewModel
                                                      .listXAttachmentPersonalImage)[i],
                                                  onTap: () {
                                                    setState(() {
                                                      viewModel
                                                          .listAttachmentPersonalImage
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment
                                        .center,
                                    children: [
                                      Text(AppStrings.allowComments.tr(),
                                        style: TextStyle(
                                      ...
                                      onPressed: () async {
                                        if (formKey.currentState!.validate()) {
                                          viewModel.addNotification(context,
                                              depIds: tempDepSelectedIds,
                                              empIds: tempSelectedIds);
                                        }
                                      },
                                    ),
                                    if(viewModel.isLoading ==
