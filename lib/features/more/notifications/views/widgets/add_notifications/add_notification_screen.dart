                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(viewModel.listIds.isEmpty
                                        ? AppStrings.employeeName.tr()
                                        : '${viewModel.listIds.length} ${AppStrings.selected.tr()}', style: TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.w400,
                                        color: Color(AppColors.almostBlack)),),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(viewModel.listIdsDepartment.isEmpty
                                        ...
                                        : '${viewModel.listIdsDepartment.length} ${AppStrings.selected.tr()}', style: TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.w400,
                                        color: Color(AppColors.almostBlack)),),
                                    const Icon(Icons.arrow_drop_down),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(AppStrings.allowComments.tr(), style: TextStyle(
                                    color: Color(AppColors.darkGrey), fontWeight: FontWeight.w400, fontSize: 12,
                                  ),),
                                  const Spacer(),
                                  GestureDetector(
                                    onTap: (){
                                    ...
                                    child: Container(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                            shape: BoxShape.circle,
                                            color: viewModel.allowComment == true? Color(AppColors.dark) : Colors.transparent
                                        ),
                                      ),
                                    ),
                                  )
