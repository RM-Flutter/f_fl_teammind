...
class RequestTypeOrList {
  ...
  factory RequestTypeOrList.fromJson(Map<String, dynamic> json) {
    return RequestTypeOrList(
      id: json['id'],
      title: LocalizedTitle.fromJson(json['title']),
      type: json['type'],
      halfDay: json['half_day_leave'],
      acceptanceTime: json['acceptance_time'],
      maximum: json['maximum'],
      countingType: json['counting_type'],
      fields: RequestFields.fromJson(json['fields']),
...
class GeneralMessageByScreen {
  ...
  factory GeneralMessageByScreen.fromJson(Map<String, dynamic> json) {
    return GeneralMessageByScreen(
      ...
      screenMessage: json['screen_message'] != null ? ScreenMessage.fromJson(json['screen_message']) : null,
    );
  }
