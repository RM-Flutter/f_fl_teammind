...
import 'package:rmemp/controller/device_sys/device_controller.dart';
                ...
                child: Column(
                  ...
                  children: [
                    Text(AppStrings.customizeNotifications.tr().toUpperCase(), style: const TextStyle(
                        ...
                        color: Color(AppColors.veryDarkBlue)
                    ),),
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(AppColors.veryDarkBlue),
      ...
      child: Row(
        ...
        children: [
          Text(AppStrings.deactivate.tr().toUpperCase(),
              style: TextStyle(
                  fontSize: 11, color: Color(AppColors.dark), fontWeight: FontWeight.w500)),
          gapW8,
          Switch(
            value: value,
            onChanged: onChanged,
            activeColor: Color(AppColors.dark),
