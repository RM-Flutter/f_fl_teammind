...
import 'package:rmemp/modules/more/views/faq/logic/faq_model.dart';
        ...
        builder: (context, value, child) {
          return Scaffold(
            ...
            appBar: AppBarWithBookmark(
              ...
              title: AppStrings.faqs.tr().toUpperCase(),
              ...
              routeName: AppRoutes.faqScreen.name,
            ),
...
class _FaqTileState extends State<FaqTile> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: Color(AppColors.lightBlueBg), // Light blue background like in the image
