...
class _PayBillScreenState extends State<PayBillScreen> {
                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(
                                              color: value.selectIndix == index?Color(AppColors.primary) :Colors.transparent,
                                              shape: BoxShape.circle,
                                            ),
                                          ),
                                        ),
                                      ...
                                      Text(widget.title ?? "", style: const TextStyle(color: Color(AppColors.primary),fontSize: 14, fontWeight: FontWeight.w700),),
                                    ],
                                  ),
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(width: MediaQuery.sizeOf(context).width * 0.6,
                                child: const Divider(color: Color(AppColors.primary),),
                              ),
  ...
  Widget defaultTransferDetailsTexts(t1, t2)=>Container(
    ...
    child: Row(
      children: [
        Text(t1, style: const TextStyle(color: Color(AppColors.primary),fontSize: 12, fontWeight: FontWeight.w600),),
        const Spacer(),
